...
if ($service.Status -eq "Stopped") {
    Get-WinEvent -LogName System -MaxEvents 5 | Where-Object { $_.Id -eq 7031 -or $_.Id -eq 7034 } | Format-Table TimeCreated, Id, Message -Wrap | Out-File "C:\test wms\thermaltrue\service_start_log.txt" -Append
}
