...
const ROUTES: Record<string, Route> = {
  ...
  get_material_by_sku:    { method: "GET", path: "/api/materials/by-sku" },
  ...
  delete_transaction: { method: "POST", path: (a) => `/api/transactions/${a.id}/delete` },
  delete_transactions_bulk: { method: "POST", path: "/api/transactions/delete-bulk", body: true },
...
mark_all_notifications_read: { method: "POST", path: "/api/notifications/read-all" },
  ...
  get_health_index:        { method: "GET", path: "/api/dashboard/health-index" },
  ...
  get_efficiency_penalty:  { method: "GET", path: "/api/cost/efficiency-penalty" },
  get_material_analysis_summary: { method: "GET", path: "/api/material-analysis/summary" },
  get_material_analysis_details: { method: "GET", path: "/api/material-analysis/details" },
  get_consumption_summary:  { method: "GET", path: "/api/consumption-analysis/summary" },
  get_consumption_details:  { method: "GET", path: "/api/consumption-analysis/details" },
  get_consumption_seasonal: { method: "GET", path: "/api/consumption-analysis/seasonal" },
  abc_classify:            { method: "POST", path: "/api/abc-analysis/classify" },
  get_abc_summary:         { method: "GET", path: "/api/abc-analysis/summary" },
  forecast_generate:       { method: "POST", path: "/api/forecast-analysis/generate" },
